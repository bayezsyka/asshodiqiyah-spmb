...
class PendaftaranController extends Controller
{
    public function index(Request $request)
    {
        ...
        $pendaftaran = Pendaftaran::query()->with(['jenjang:id,nama', 'periode:id,nama,tahun_ajaran'])
        ...
        return Inertia::render('Admin/Pendaftaran/Index', [
            ...
            'filter' => $filter,
            'jenjang' => JenjangPendaftaran::where('status_aktif', true)->orderBy('urutan')->get(['id', 'nama', 'kelompok']),
            'periode' => $periodeList,
